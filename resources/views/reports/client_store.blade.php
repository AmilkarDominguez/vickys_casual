            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12 d-flex justify-content-center">
                        <h2 class="card-title text-primary">Clientes registrados por sucursal</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            table = $('#table').DataTable({
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        titleAttr: 'Imprimir',
                        extend: 'print',
                        messageTop: 'Cantidad de usuarios por sucursal: ' + $("#store_id option:selected").text() + '<br>Fechas: ' + $("#minimum_date").val() + ' - ' + $("#maximum_date").val(),
                        footer: true,
                        exportOptions: {
                            columns: [0, 1, 2, 3, 4]
                        }
